...
install() {
  ...
  echo "Comment=A darker and more modern twist on the Layan GTK Theme" >> ${THEME_DIR}/index.theme
  echo "Encoding=UTF-8" >> ${THEME_DIR}/index.theme
  echo "" >> ${THEME_DIR}/index.theme
  echo "[X-GNOME-Metatheme]" >> ${THEME_DIR}/index.theme
  echo "GtkTheme=${name}" >> ${THEME_DIR}/index.theme
  echo "MetacityTheme=${name}" >> ${THEME_DIR}/index.theme
  echo "IconTheme=Papirus" >> ${THEME_DIR}/index.theme
  echo "CursorTheme=Layan" >> ${THEME_DIR}/index.theme
...
install "${dest:-${DEST_DIR}}" "${THEME_NAME}" "-dark" "-solid"
